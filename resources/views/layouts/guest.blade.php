...
<body class="bg-gradient-page flex min-h-screen flex-col">
    <header class="relative z-20 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4">
        <div class="animate-fadeUp flex items-center gap-2.5">
            <div class="flex h-9 w-9 items-center justify-center rounded-xl"
                style="background:linear-gradient(135deg,#3b82f6,#1d4ed8);box-shadow:0 4px 16px rgba(37,99,235,0.40);">
                <svg aria-hidden="true" fill="white" height="18" viewBox="0 0 24 24" width="18">
                    <path
            ...
            <span class="font-display text-base font-bold" style="color:var(--text);font-family:'Outfit',sans-serif;">
                People<span class="text-blue-500">Core</span>
            </span>
        </div>
        <button aria-label="Toggle dark mode" class="toggle-pill animate-fadeUp" id="themeBtn"
            onclick="toggleDarkMode()" title="Toggle dark/light mode">
            <svg fill="currentColor" height="14" id="iconSun" style="display:none;" viewBox="0 0 24 24"
                width="14">
                <path
            ...
            <svg fill="currentColor" height="14" id="iconMoon" viewBox="0 0 24 24" width="14">
                <path
