            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div class="field-wrap relative">
                        <select
                            ...
                            @foreach ($roles as $id => $role)
                                <option @selected(old('role', $user->role) === $role)>
                                    {{ ucfirst($role) }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        {{-- Male --}}
                        <div>
                            <input {{ old('gender', $user->gender) === 'male' ? 'checked' : '' }} class="peer hidden"
                        ...
                        {{-- Female --}}
                        <div>
                            <input {{ old('gender', $user->gender) === 'female' ? 'checked' : '' }} class="peer hidden"
                        ...
                        {{-- Other --}}
                        <div>
                            <input {{ old('gender', $user->gender) === 'other' ? 'checked' : '' }} class="peer hidden"
