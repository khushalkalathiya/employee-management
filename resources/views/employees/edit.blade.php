                    ...
                    <div class="mb-5 grid grid-cols-1 gap-5 md:grid-cols-5">
                        ...
                        <div class="image-upload">
                            <input accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp"
                                class="image-input hidden" name="avatar" type="file">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <svg class="h-8 w-8 text-gray-400 dark:text-gray-500" fill="none"
                                        stroke-width="1.8" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                {{-- Male --}}
                                <div>
                                    <input {{ old('gender', $employee->gender) === 'male' ? 'checked' : '' }}
                                        class="peer hidden" id="gender_male" name="gender" type="radio"
                                        value="male">
                                ...
                                {{-- Female --}}
                                <div>
                                    <input {{ old('gender', $employee->gender) === 'female' ? 'checked' : '' }}
                                        class="peer hidden" id="gender_female" name="gender" type="radio"
                                        value="female">
                                    ...
                                    <label
                                        ...
                                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                                                d="M12 2a5 5 0 0 0-1 9.9V14H8v2h3v3h2v-3h3v-2h-3v-2.1A5 5 0 0 0 12 2z" />
                                        </svg>
                                ...
                                {{-- Other --}}
                                <div>
                                    <input {{ old('gender', $employee->gender) === 'other' ? 'checked' : '' }}
                                        class="peer hidden" id="gender_other" name="gender" type="radio"
                                        value="other">
