                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <div>
                            <input {{ old('gender', $employee->gender) === 'male' ? 'checked' : '' }}
                                class="peer hidden" id="gender_male" name="gender" type="radio" value="male">
                        ...
                        <div>
                            <input {{ old('gender', $employee->gender) === 'female' ? 'checked' : '' }}
                                class="peer hidden" id="gender_female" name="gender" type="radio" value="female">
                        ...
                        <div>
                            <input {{ old('gender', $employee->gender) === 'other' ? 'checked' : '' }}
                                class="peer hidden" id="gender_other" name="gender" type="radio" value="other">
