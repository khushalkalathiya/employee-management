        ...
        <div
            ...
            <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap">
                <div class="search-wrap" style="margin-left:8px">
                    ...
                    <input class="search-inp" placeholder="Search leave types" style="min-width:250px" type="text"
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <x-table-sort :extra-sort-class="'flex justify-center'" :sort-direction="$sortDirection" :sort-field="$sortField" field="monthly_limit"
                            label="Monthly Limit" />
                    ...
                    @forelse($leaveTypes as $leaveType)
                        <tr>
                            ...
                            <td class="text-center">
                                {{ $leaveType->monthly_limit !== null ? (int) $leaveType->monthly_limit : '-' }}</td>
                                ...
                                <div style="display:flex;align-items:center;gap:6px">
                                    @can('leave_type.edit')
                                        <button class="btn-ghost js-edit-leave-type"
                                            ...
                                            data-description="{{ $leaveType->description }}" data-id="{{ $leaveType->id }}"
                                            data-monthly-limit="{{ $leaveType->monthly_limit }}"
                                            data-name="{{ $leaveType->name }}" style="padding:6px" title="Edit"
                                            type="button">
                                    ...
                                    @can('leave_type.delete')
                                        <button class="btn-ghost js-delete-confirm"
                                            ...
                                            data-url="{{ route('leave-types.destroy', $leaveType) }}" style="padding:6px"
