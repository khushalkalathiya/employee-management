<div>
    <div style="margin-bottom:20px">
        ...
        <div
            ...
            <div>
                <div class="section-title">Employees Management</div>
                <div class="section-sub">Manage system employees</div>
            </div>
            ...
            <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap">
                ...
                @can('employee.create')
                    <a class="btn-primary inline-flex h-fit items-center no-underline"
        ...
        <div class="card" style="overflow-x:auto">
            ...
            <table class="data-table">
                ...
                <thead>
                    <tr>
                        <x-table-sort :sort-direction="$sortDirection" :sort-field="$sortField" field="first_name" label="Name" />
                ...
                <tbody>
                    ...
                    @forelse($employees as $employee)
                        @php $role = $employee->roles->first() ?? null; @endphp
                        <tr>
                            ...
                            <td>
                                {{ $employee->joining_date ? dateFormat($employee->joining_date) : '-' }}
                            </td>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:6px">
                                    ...
                                    @can('employee.view')
                                        <a class="btn-ghost" href="{{ route('employees.show', $employee) }}"
                                            style="padding:6px" title="View">
                                    ...
                                    @can('employee.delete')
                                        @if (($role && $role->name !== 'superadmin') || has_role('superadmin'))
                                            <button class="btn-ghost js-delete-confirm"
                                                data-description="Are you sure you want to delete {{ $employee->full_name }}?"
                                                data-title="Delete Employee"
                                                data-url="{{ route('employees.destroy', $employee) }}" style="padding:6px"
