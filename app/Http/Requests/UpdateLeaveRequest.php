...
class UpdateLeaveRequest extends FormRequest
{
    public function authorize()
    {
        ...
        if (has_permission('leave.own') && has_permission('leave.edit')) {
            return has_permission('leave.own') && $leave && $leave->user_id === authId() && $leave->status == 0;
        }

        return has_permission('leave.edit');
